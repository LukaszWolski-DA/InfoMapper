...
import type { DiagramItem, Entity, Relationship, Attribute, LogicalEntity, LogicalAttribute } from "@/lib/types"
      ...
      {isLeftPanelVisible ? (
        <aside className="bg-gray-50 border-r border-gray-200 p-4 overflow-y-auto" style={{ width: `${leftPanelWidth}px`, maxWidth: '40vw', minWidth: '220px' }}>
          ...
          <ModelObjectTree
            ...
            onSearchChange={setEntityFilter}
      ...
      <div className="flex-1 flex flex-col">
        <header className="bg-white border-b border-gray-200 px-6 py-4 shadow-sm">
          <div className="flex items-center justify-between">
            <h1 className="text-xl font-semibold text-gray-900">Model</h1>
          ...
          <p className="text-xs text-gray-600 mt-2">
            <strong>Instructions:</strong> Drag entities onto the diagram and build associations. Click on associations to modify or remove.
            <br />
            <strong>Colors:</strong> Black lines = association
          </p>
        </header>
        <ModelDiagramArea
          items={diagramItems}
